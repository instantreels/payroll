    ...
    <div class="grid grid-cols-1 lg:grid-cols-4 gap-8">
        ...
        <div class="lg:col-span-1">
            <nav class="space-y-1">
                ...
                <a href="#notifications" class="settings-nav-link text-gray-700 hover:text-gray-900 hover:bg-gray-50 group flex items-center px-3 py-2 text-sm font-medium rounded-md">
                        ...
                        <form id="notification-settings-form">
                            <div class="space-y-6">
                                <div>
                                    ...
                                    <div class="space-y-3">
                                        <label class="flex items-center">
                                            <input type="checkbox" name="notify_payroll_complete" class="form-checkbox" checked>
                                            <span class="ml-2 text-sm text-gray-700">Payroll processing completed</span>
                                        </label>
                                        <label class="flex items-center">
                                            <input type="checkbox" name="notify_new_employee" class="form-checkbox" checked>
                                            <span class="ml-2 text-sm text-gray-700">New employee added</span>
                                        </label>
                                        <label class="flex items-center">
                                            <input type="checkbox" name="notify_loan_payment" class="form-checkbox">
                                            <span class="ml-2 text-sm text-gray-700">Loan payment recorded</span>
                                        </label>
                                        <label class="flex items-center">
                                            <input type="checkbox" name="notify_backup_complete" class="form-checkbox">
                                            <span class="ml-2 text-sm text-gray-700">Backup completed</span>
                                        </label>
                                    </div>
                                </div>
                                
                                <div>
                                    <h4 class="text-md font-semibold text-gray-900 mb-4">Browser Notifications</h4>
                                    <div class="space-y-3">
                                        <label class="flex items-center">
                                            <input type="checkbox" name="browser_notifications" class="form-checkbox">
                                            <span class="ml-2 text-sm text-gray-700">Enable browser notifications</span>
                                        </label>
                                        <label class="flex items-center">
                                            <input type="checkbox" name="sound_notifications" class="form-checkbox">
                                            <span class="ml-2 text-sm text-gray-700">Play sound for notifications</span>
                                        </label>
                                    </div>
                                </div>
                                
                                <div>
                                    <label for="notification_retention" class="block text-sm font-medium text-gray-700 mb-2">Notification Retention (days)</label>
                                    <input type="number" name="notification_retention" id="notification_retention" 
                                           value="30" min="1" max="365" class="form-input w-32">
                                </div>
                            </div>
