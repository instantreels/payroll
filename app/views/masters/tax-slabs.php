    ...
    <div class="md:flex md:items-center md:justify-between mb-8">
        <div class="flex-1 min-w-0">
            ...
            <p class="mt-1 text-sm text-gray-500">
                Configure income tax slabs for different financial years
            </p>
        </div>
        <div class="mt-4 flex md:mt-0 md:ml-4 space-x-3">
            <select id="fy-filter" class="form-select">
                <?php foreach ($financial_years as $fy): ?>
                    <option value="<?php echo $fy['financial_year']; ?>" 
                            <?php echo $fy['financial_year'] === $current_fy ? 'selected' : ''; ?>>
                        ...
                        <?php foreach ($tax_slabs as $slab): ?>
                            <tr class="hover:bg-gray-50">
                                <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-900">
                                    ₹<?php echo number_format($slab['min_amount'], 0); ?>
                                    <?php if ($slab['max_amount']): ?>
                                        - ₹<?php echo number_format($slab['max_amount'], 0); ?>
                                    <?php else: ?>
                                        & above
                                    <?php endif; ?>
                                </td>
                        ...
                        <tr>
                            <td colspan="5" class="px-6 py-12 text-center">
                                <div class="text-gray-500">
                                    ...
                                    <p class="text-lg font-medium">No tax slabs found for FY <?php echo $current_fy; ?></p>
                                    <p class="text-sm">Add tax slabs to configure income tax calculations</p>
            ...
            <form id="tax-slab-form">
                ...
                <div class="mb-4">
                    ...
                    <input type="number" name="min_amount" id="min_amount" required
                           class="form-input" placeholder="0" min="0" step="1">
                </div>
                ...
                <div class="mb-4">
                    ...
                    <input type="number" name="max_amount" id="max_amount"
                           class="form-input" placeholder="Leave empty for no limit" min="0" step="1">
                </div>
                ...
                <div class="mb-4">
                    ...
                    <input type="number" name="tax_rate" id="tax_rate" required
                           class="form-input" placeholder="0" min="0" max="100" step="0.01">
                </div>
...
document.getElementById('fy-filter').addEventListener('change', function() {
    const selectedFY = this.value;
    window.location.href = `/tax-slabs?fy=${selectedFY}`;
});
</script>
